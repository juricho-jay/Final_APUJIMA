...
public class MenuGroup extends Menu {
  ...
  ArrayList<Menu> childs = new ArrayList<>(); //ArrayList로 메뉴들을 보관하는 childs

  //LinkedList는 양방향 포인터 구조임. 
  //=> 데이터 삽입, 삭제가 빈번할 때 데이터의 위치 정보만 수정하면 되기 때문에 유용함  
  //=> 스택, 큐, 양방향 큐 등을 만들기 위한 용도로 씀

  //ArrayList는 단뱡향 포인터 구조.
  //=> 데이터에 대한 인덱스를 가지고 있어 조회 기능이 뛰어남
  //=> 메뉴 조회
