...
<script src="../node_modules/bootstrap/dist/js/bootstrap.js"></script>
  ...
  <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
    ...
    if(!document.bucketAdd.title.value){
         alert("제목을 입력하세요");
         return false;
     }
    if(!document.bucketAdd.content.value){
        alert("내용을 입력하세요");
        return false;
    }
    if(!document.bucketAdd.id.value){
        alert("작성자를 입력하세요");
        return false;
    }
...
<form action='delete'>
<!-- 모달 영역 -->
<div id="modalBox" class="modal fade" id="myModal2" tabindex="-1" 
role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h4 class="modal-title w-100 font-weight-bold">버킷리스트 삭제</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
       <div class="modal-body mx-3">
        <div class="md-form mb-2">
          <i class="fas fa-user prefix grey-text"></i>
          <input type="text" id="bucket-title" name="title" class="form-control validate">
          <label data-error="wrong" data-success="right" for="bucket-title">삭제할 버킷리스트 번호</label>
        </div>
      </div>
      <div class="modal-footer">
    <!-- <button type="button" id="bucketAddBtn" class="btn btn-primary">확인</button> -->
