                                    ...
                                    <div class="widget-content p-0">
                                        <div class="widget-content-wrapper">
                                            ...
                                            <div class="widget-content-left">
		                                            ...
		                                            onclick="updateBucket('${bucket.no}')">
...
<!-- 내용 변경 업데이트 모달 영역 -->        
<form id="updateForm" action='contentUpdate'>
...
// 내용 업데이트 데이터 모달에 넘기기
 function updateBucket(no) {
    var updateForm= $('#updateForm');
    $('<input>').attr('type','hidden').attr('value', no).attr('name','no').appendTo(updateForm);
   /*  $('<input>').attr('type','hidden').attr('value', title).attr('name','title').appendTo(updateForm);
