   ...
   <script type="text/javascript">
        ...
        function checkValue()
        {
           ...
           if(!document.boardInfo.title.value){
            ...
            if(!document.boardInfo.content.value){
                alert("내용을 입력하세요.");
                return false;
            } 
...
<div class="mb-3 row">
    <label for='f-writer' class="col-sm-3 col-form-label">작성자</label>
    <div class="col-sm-6">
     <input id='f-id' type='text' class="form-control"  value='${loginUser.nickname}' readonly>
    </div>
</div>
