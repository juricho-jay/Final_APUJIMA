  ...
  <div class=container style=" height:1800px;">
			<div style="text-align: center;">
			 ...
			 <div class = "introduce1" style="width:1100px; margin:auto; margin-bottom:100px;">
			     ...
			     <div class = "introduceInfo" style=" float:left; margin-left:80px; margin-top :70px;">
					     ...
					     <br><br>
					     <ul>
					         <li>무료로 상담을 진행하고 있어요.</li>
					         <li>함께 고민해주는 사람들이 모여있어 자유롭게 이야기를 나눠보세요</li>
					         <li>버킷리스트로 완료 시 성취감을 느껴보세요</li>
					         <li>전문답변이 필요하다면 익명으로 솔직하게 써주세요</li>
					     </ul>
             </div>
        </div>
        ...
        <div class = "introduce1" style="width:1100px; margin:auto;">
           ...
           <div class = "introduceInfo" style=" float:right; margin-top:80px;">
               ...
               <ul>
                   <li>자격요건 확인</li>
                    <span>관련 분야의 석사/ 박사 학위와 전문 자격증을 소지한<br>실무 경력을 갖춘 전문가만 엄격히 채용합니다.</span>
                   <li>면접 전형</li>
                    <span>정신건강 검사 후 인성 면접과 역량 평가를 통해 전문가의 자질을 검증합니다.</span>
                   <li>분야별 채용</li>
                    <span>다양한 분야별로 전문가를 채용하여 전문성 있는 서비스를 제공합니다.</span>
               </ul>
             </div>
        </div>
   </div>
