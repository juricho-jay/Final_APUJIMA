...
@PropertySource("classpath:apus/config/jdbc.properties")
...
public class AppConfig {
  ...
  public SqlSessionFactory sqlSessionFactory(
    ...
    // 
    sqlSessionFactoryBean.setTypeAliasesPackage("apus.domain");
    sqlSessionFactoryBean.setMapperLocations(
        appCtx.getResources("classpath:apus/dao/*Dao.xml"));
