...
@WebServlet("/board/CommentUpdateForm2")
public class CommentUpdateFormController2 extends HttpServlet {
  ...
  public void service(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      request.getRequestDispatcher("/board/CommentUpdateForm2.jsp").forward(request, response);
